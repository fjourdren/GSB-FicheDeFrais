...
<form action="visiteur-modifierAction.php" method="post">
	...
	<fieldset>
		...
		<table class="align">
			...
			<tr>
				<td colspan="4"><button class="icone" title="R&#233;initialiser" type="reset"><img src="images/icones/reset.png" alt="R&#233;initialiser"></button><input class="icone" type="image" src="images/icones/save.png" title="Modifier la fiche de frais" alt="Modifier la fiche de frais" /></td>
			</tr>
